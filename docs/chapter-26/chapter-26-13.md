...
Once
the subroutine is written,
you can use it whenever you need the function
it performs.
Now finish the main program:
...
main:
         jal             # read first integer
         nop                      #  
         move    $s0,$v0          # save it in $s0

         jal             # read second integer
         nop                      # 
         move    $s1,$v0          # save it in $s1

         jal             # read third integer
         nop                      #  
